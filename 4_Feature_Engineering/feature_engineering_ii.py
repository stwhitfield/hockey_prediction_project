...
extra_feat = pd.read_csv('tidy4.csv')
...
data = pd.DataFrame({'gameId': df['gameId'].astype(str),
                     'gameSeconds': df['gameSeconds'],
                     'period': df['period'],
                     'coordinateX': df['coordinateX'],
                     'coordinateY': df['coordinateY'],
                    'distanceFromNet': df['distanceFromNet'],
                     'angleFromNet': df['angleFromNet'],
                     'shotType': df['shotType'],
                     'lastEventType' : df['lastEventType'],
                     'last_coordinateX': df['last_coordinateX'],
                     'last_coordinateY': df['last_coordinateY'],
                     'time_from_lastEvent' : df['time_from_lastEvent'],
                     'last_distanceFromNet' : df['last_distanceFromNet'],
                     'rebound': df['rebound'],
...
# output to csv
train_data.to_csv('feii_train.csv')
test_data.to_csv('feii_test.csv')
