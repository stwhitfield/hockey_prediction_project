...
experiment_name = "rf_grid_search_best_model_params"  #base name for log_model, log_image
...
saved_model = "../rf_random_best_model.pkl"
rf_grid_search_model = joblib.load(saved_model)
...
y_pred = rf_grid_search_model.predict(X_val)
accuracy = metrics.accuracy_score(y_val, y_pred)

#Probability estimates
pred_probs = rf_grid_search_model.predict_proba(X_val)
...
experiment.log_parameters(rf_best_params)
